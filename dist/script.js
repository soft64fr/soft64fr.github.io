...
var TARGET_DATE = new Date('2026-03-31T00:00:00').getTime();
...
function _startApp() {
  _startApp = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return Localization.initializeI18n();
        case 1:
          countdown();
          if (timerId === null) {
